...
public class SteamManager : MonoBehaviour
{
	...
	// Token: 0x06000005 RID: 5 RVA: 0x00003B44 File Offset: 0x00001D44
	protected virtual void Awake()
	{
		...
		try
		{
			if (SteamAPI.RestartAppIfNecessary((AppId_t)3274300U))
			{
	...
	// Token: 0x06000006 RID: 6 RVA: 0x00003C30 File Offset: 0x00001E30
