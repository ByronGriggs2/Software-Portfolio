...
Lab4_Q3B::Lab4_Q3B() : Scenario() {
	...
	ObjectPresets leftSphere(shapeHelpers::sphere, "obj0.obj", XMMatrixTranslation(-3, 0, -3), XMVectorSet(3, 0, 3, 0), false, 10);
	leftSphere._initData._sphere._radius = 1.0f;
	_objectPresets.push_back(leftSphere);

	ObjectPresets rightSphere(shapeHelpers::sphere, "obj0.obj", XMMatrixTranslation(3, 0, 3), XMVectorSet(-3, 0, -3, 0), false, 25);
	rightSphere._initData._sphere._radius = 1.0f;
	_objectPresets.push_back(rightSphere);
}

void Lab4_Q3B::generateObjects() const {
