...
Lab4_Q2C::Lab4_Q2C() : Scenario() {
	...
	ObjectPresets leftSphere(shapeHelpers::sphere, "obj0.obj", XMMatrixTranslation(-3, 0, 0.8), XMVectorSet(3, 0, 0, 0));
	leftSphere._initData._sphere._radius = 1.0f;
	_objectPresets.push_back(leftSphere);

	ObjectPresets rightSphere(shapeHelpers::sphere, "obj0.obj", XMMatrixTranslation(0, 0, 0), XMVectorSet(0, 0, 0, 0));
	rightSphere._initData._sphere._radius = 1.0f;
	_objectPresets.push_back(rightSphere);
}

void Lab4_Q2C::generateObjects() const {
