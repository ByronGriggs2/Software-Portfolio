...
Lab4_Q2D::Lab4_Q2D() : Scenario() {
	...
	ObjectPresets rightSphere(shapeHelpers::sphere, "obj0.obj", XMMatrixTranslation(3, 0, 0), XMVectorSet(-3, 0, 0, 0));
	rightSphere._initData._sphere._radius = 1.0f;
	_objectPresets.push_back(rightSphere);
}

void Lab4_Q2D::generateObjects() const {
