this.vizier <- this.inherit("scripts/entity/tactical/human", {
	...
	function create()
	{
		...
		this.m.Name = this.Const.Strings.SouthernFemaleNames[this.Math.rand(0, this.Const.Strings.SouthernFemaleNames.len() - 1)] + " " + this.Const.Strings.SouthernNamesLast[this.Math.rand(0, this.Const.Strings.SouthernNamesLast.len() - 1)];
