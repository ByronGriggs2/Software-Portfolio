this.nomad_leader <- this.inherit("scripts/entity/tactical/human", {
	...
	function generateName()
	{
		if (this.m.SexH == 0){
			...
			return this.Const.Strings.SouthernFemaleNames[this.Math.rand(0, this.Const.Strings.SouthernFemaleNames.len() - 1)] + " " + this.Const.Strings.NomadChampionTitles[this.Math.rand(0, this.Const.Strings.NomadChampionTitles.len() - 1)];
		}
	}
