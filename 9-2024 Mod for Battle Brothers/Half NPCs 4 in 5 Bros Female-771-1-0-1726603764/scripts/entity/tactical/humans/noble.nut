this.noble <- this.inherit("scripts/entity/tactical/human", {
	...
	function generateName()
	{
		if (this.m.SexH == 0){
			...
			return this.Const.Strings.NoblewomanTitles[this.Math.rand(0, this.Const.Strings.NoblewomanTitles.len() - 1)] + " " + this.Const.Strings.CharacterNamesFemale[this.Math.rand(0, this.Const.Strings.CharacterNamesFemale.len() - 1)];
		}
	}
